 ...
 */
export function useGetReportsStockByBrand<
  TData = GetReportsStockByBrandQueryResponse,
  TQueryData = GetReportsStockByBrandQueryResponse,
  TQueryKey extends QueryKey = GetReportsStockByBrandQueryKey,
>(
  params?: GetReportsStockByBrandQueryParams,
  options: {
    query?: Partial<
  ...
  const query = useQuery(
    ...
    queryClient,
  ) as UseQueryResult<TData, ResponseErrorConfig<GetReportsStockByBrand400>> & {
    queryKey: TQueryKey;
  };
